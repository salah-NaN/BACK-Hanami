...
// seccion de lo que tiene el propietario
    ...
    // relacion 1 a N
    Propietarios.hasMany(Puntos_interes, { foreignKey: 'propietario_id', onDelete: 'CASCADE', hooks: true })
...
// seccion de imagenes con cada tabla que lo requiera
    ...
    // relacion 1 a N 
    Puntos_interes.hasMany(Imagenes, { foreignKey: 'punto_interes_id', onDelete: 'CASCADE', hooks: true })
    ...
    // relacion 1 a N 
    Actividades.hasMany(Imagenes, { foreignKey: 'actividad_id', onDelete: 'CASCADE', hooks: true })
...
// es creada manualmente
    ...
    // relacion 1 a N 
    Actividades.hasMany(Resenias, { foreignKey: 'actividad_id', onDelete: 'CASCADE', hooks: true })
